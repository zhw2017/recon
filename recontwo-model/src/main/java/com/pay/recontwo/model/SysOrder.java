...
public class SysOrder extends BaseMapperVO {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5538617012717454664L;
	/** 对接机构 */
...
//	@NotBlank
	...
	public String toString() {
		return "SysOrder [accessInst=" + accessInst + ", busiType=" + busiType + ", busiCode=" + busiCode + ", busiName=" + busiName + ", organization="
				...
				+ transAmount + ", transFee=" + transFee + ", transCost=" + transCost + ", otherCost=" + otherCost + ", cardType=" + cardType + ", pan=" + pan
				+ ", bankFlowId=" + bankFlowId + ", oldBankFlowId=" + oldBankFlowId + ", requestId=" + requestId + ", oriOrderId=" + oriOrderId + ", orderCenterId="
				+ orderCenterId + ", oldRequestId=" + oldRequestId + ", bankBatchNo=" + bankBatchNo + ", bankPosCati=" + bankPosCati + ", sysPosCati=" + sysPosCati
